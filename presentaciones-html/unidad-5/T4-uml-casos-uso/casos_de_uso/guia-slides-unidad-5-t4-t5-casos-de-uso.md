# Guía de regeneración de Unidad V · T4-b - Casos de Uso

Guía docente para regenerar la presentación a partir de `sesiones-clase/clase-4/IS1-UNIDAD_IV.pptx`. Conserva los **21 slides**, su orden y su numeración de origen, después de eliminar el slide de referencias. La futura presentación deberá usar esta guía como especificación de contenido, no como sustituto del diseño visual.

**Archivo:** `guia-slides-unidad-5-t4-t5-casos-de-uso.md`
**Ubicación:** `presentaciones-html/unidad-5/T4-uml-casos-uso/casos_de_uso/`
